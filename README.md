...
> 本仓库是 [WecomTeam/wecom-aibot-python-sdk](https://github.com/WecomTeam/wecom-aibot-python-sdk) 的 fork，在官方 1.0.2 上合入临时素材上传、多媒体回复，以及 asyncio 回调修复。按 GitHub tag 发布；不要发到 pypi.org（包名属于 WecomTeam）。
>
